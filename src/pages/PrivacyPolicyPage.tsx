  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
      <div className="max-w-[700px] mx-auto px-6 py-12 space-y-8">
        ...
        <section className="space-y-3 text-sm leading-relaxed text-gray-700">
          <h2 className="text-base font-semibold text-gray-900">3. Uso de datos de Google</h2>
          <p>El uso y la transferencia a cualquier otra aplicación de la información recibida de las API de Google se adhiere a la <a href="https://developers.google.com/terms/api-services-user-data-policy" target="_blank" rel="noopener noreferrer" className="text-green-600 underline hover:text-green-700">Política de datos de usuario de los servicios de API de Google</a>, incluidos los requisitos de uso limitado.</p>
          <p>Específicamente:</p>
          <ul className="list-disc pl-5 space-y-1">
        ...
        <section className="space-y-3 text-sm leading-relaxed text-gray-700">
          <h2 className="text-base font-semibold text-gray-900">4. Almacenamiento y seguridad</h2>
        ...
        <section className="space-y-3 text-sm leading-relaxed text-gray-700">
          <h2 className="text-base font-semibold text-gray-900">5. Base legal y cumplimiento (GDPR / CCPA)</h2>
        ...
        <section className="space-y-3 text-sm leading-relaxed text-gray-700">
          <h2 className="text-base font-semibold text-gray-900">6. Compartir información</h2>
        ...
        <section className="space-y-3 text-sm leading-relaxed text-gray-700">
          <h2 className="text-base font-semibold text-gray-900">7. Tus derechos</h2>
          <ul className="list-disc pl-5 space-y-1">
        ...
        <section className="space-y-3 text-sm leading-relaxed text-gray-700">
          <h2 className="text-base font-semibold text-gray-900">8. Cookies y tecnologías similares</h2>
        ...
        <section className="space-y-3 text-sm leading-relaxed text-gray-700">
          <h2 className="text-base font-semibold text-gray-900">9. Datos de niños</h2>
        ...
        <section className="space-y-3 text-sm leading-relaxed text-gray-700">
          <h2 className="text-base font-semibold text-gray-900">10. Cambios a esta política</h2>
