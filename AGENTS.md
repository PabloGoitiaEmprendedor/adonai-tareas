...
- UI/design MCP: prefer Stitch for app screens, visual redesigns, component layouts, and design-system extraction when the MCP or a Stitch export is available.
