...
export const getTutorialSteps = ({ hasGoals }: TutorialStepsOptions): Step[] => {
  const steps: Step[] = [
    ...
    },
    {
      ...
      content: 'Este es tu centro de organización. Aquí divides tus grandes metas en áreas manejables como Trabajo, Salud o Proyectos Personales.',
      placement: 'bottom',
      disableBeacon: true,
      spotlightClicks: false,
    },
    {
      ...
      content: 'Este botón es tu punto de partida. Úsalo para crear espacios dedicados a cada sueño o responsabilidad principal.',
      placement: 'bottom',
      disableBeacon: true,
      spotlightClicks: false,
    },
