  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
      <div className="max-w-[700px] mx-auto px-6 py-12 space-y-8">
        ...
        <p className="text-sm text-gray-500">Última actualización: 11 de mayo de 2026</p>

        <section className="space-y-3 text-sm leading-relaxed text-gray-700">
          <h2 className="text-base font-semibold text-gray-900">1. Aceptación de los términos</h2>
        ...
        <section className="space-y-3 text-sm leading-relaxed text-gray-700">
          <h2 className="text-base font-semibold text-gray-900">2. Descripción del servicio</h2>
        ...
        <section className="space-y-3 text-sm leading-relaxed text-gray-700">
          <h2 className="text-base font-semibold text-gray-900">3. Registro y cuenta</h2>
          <ul className="list-disc pl-5 space-y-1">
        ...
        <section className="space-y-3 text-sm leading-relaxed text-gray-700">
          <h2 className="text-base font-semibold text-gray-900">4. Uso aceptable</h2>
        ...
        <section className="space-y-3 text-sm leading-relaxed text-gray-700">
          <h2 className="text-base font-semibold text-gray-900">5. Propiedad intelectual</h2>
        ...
        <section className="space-y-3 text-sm leading-relaxed text-gray-700">
          <h2 className="text-base font-semibold text-gray-900">6. Integración con Google</h2>
          ...
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li>Adonai cumple estrictamente con la <a href="https://developers.google.com/terms/api-services-user-data-policy" target="_blank" rel="noopener noreferrer" className="text-green-600 underline hover:text-green-700">Política de datos de usuario de los servicios de API de Google</a>.</li>
        ...
        <section className="space-y-3 text-sm leading-relaxed text-gray-700">
          <h2 className="text-base font-semibold text-gray-900">7. Servicio de IA</h2>
        ...
        <section className="space-y-3 text-sm leading-relaxed text-gray-700">
          <h2 className="text-base font-semibold text-gray-900">8. Limitación de responsabilidad</h2>
        ...
        <section className="space-y-3 text-sm leading-relaxed text-gray-700">
          <h2 className="text-base font-semibold text-gray-900">9. Modificaciones</h2>
        ...
        <section className="space-y-3 text-sm leading-relaxed text-gray-700">
          <h2 className="text-base font-semibold text-gray-900">10. Cancelación y eliminación de cuenta</h2>
        ...
        <section className="space-y-3 text-sm leading-relaxed text-gray-700">
          <h2 className="text-base font-semibold text-gray-900">11. Ley aplicable</h2>
        ...
        <section className="space-y-3 text-sm leading-relaxed text-gray-700">
          <h2 className="text-base font-semibold text-gray-900">12. Contacto</h2>
          <p>Para consultas sobre estos términos, puedes contactarnos en:</p>
          <p className="mt-2">
            Email: <a href="mailto:support@adonai-app.com" className="text-green-600 underline hover:text-green-700">support@adonai-app.com</a>
          </p>
        </section>
      </div>
    </div>
